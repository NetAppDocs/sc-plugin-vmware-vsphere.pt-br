...
---
= Acesse as APIs REST usando a página da API Swagger para o SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Antes de começar
Para acessar as APIs REST do SnapCenter Plug-in for VMware vSphere , certifique-se de ter o endereço IP ou o nome do host do SnapCenter Plug-in for VMware vSphere.
