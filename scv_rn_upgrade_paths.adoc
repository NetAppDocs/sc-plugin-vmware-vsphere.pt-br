...
---
= Caminhos de atualização para o SnapCenter Plug-in para VMware vSphere
:allow-uri-read: 
...
[NOTE]
====
A atualização para SnapCenter Plug-in para VMware vSphere (SCV) 4.8 e versões superiores é compatível apenas com o VMware vCenter Server 7 update 1 e versões posteriores. Para VMware vCenter Server anteriores à versão 7 update 1, você deve continuar usando o SCV 4.7.
