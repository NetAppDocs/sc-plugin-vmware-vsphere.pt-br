...
.Passos
. Selecione *Menu* e selecione a opção de menu *armazenamento*, depois selecione um datastore, depois selecione a guia *Configurar* e, em seguida, selecione *backups* na seção *Plug-in SnapCenter para VMware vSphere*.
