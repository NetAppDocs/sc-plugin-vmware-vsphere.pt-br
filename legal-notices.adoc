...
summary:  
---
= Avisos legais para o SnapCenter Plug-in para VMware vSphere
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
https://library.netapp.com/ecm/ecm_download_file/ECMLP3359465["Aviso sobre o SnapCenter Plug-in for VMware vSphere 6.2"^]
