...
---
= Planejamento e requisitos de implantação para o SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
| Ferramentas do ONTAP para VMware | O SnapCenter Plug-in for VMware vSphere usa isso para gerenciar datastores vVol (volumes virtuais VMware). Para versões suportadas, consulte https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["Ferramenta de Matriz de interoperabilidade do NetApp"^] . 


| Amazon FSxN para armazenamento NetApp ONTAP | 9.10 e acima 
|===
Para obter as informações mais recentes sobre as versões suportadas, consulte https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["Ferramenta de Matriz de interoperabilidade do NetApp"^] .
