...
keywords:  
summary: Se você não souber a senha de administrador da interface de usuário de gerenciamento do SnapCenter Plug-in for VMware vSphere , poderá definir uma nova senha no console de manutenção. 
---
= Modifique a senha do SCV no console de manutenção
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Se você não souber a senha de administrador da interface de usuário de gerenciamento do SnapCenter Plug-in for VMware vSphere , poderá definir uma nova senha no console de manutenção.
